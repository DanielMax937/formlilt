...
At root signature/date/name are row indices for the primary user's signature, associated complete signed-date field and full name if identifiable; otherwise -1. The root date must not refer to one component of a split date.
